PRODUCT_PROPERTY_OVERRIDES +=  \
    ...
    ro.config.alarm_alert=FANTASIA.ogg \
    ro.config.default_message0=DECISO.ogg \
    ro.config.default_message1=DECISO.ogg \
    ro.config.default_message=DECISO.ogg \
    ro.config.low_ram=true \
    ro.config.notification_sound=FACILE.ogg \
    ro.config.ringtone0=CAVATINA.ogg \
    ro.config.ringtone1=JOYEUX.ogg \
    ro.config.ringtone=CAVATINA.ogg \
    ro.control_privapp_permissions=log \
    ro.hardware.keystore=sprdtrusty \
    ro.hotspot.enabled=1 \
    ro.keybox.id.value=K9_Smart_Plus \
